This fork makes an older version (2.3.0) compatible with the latest switch dev toolkit since the older version crashed on the latest atmosphere but the newer versions of ftpd are missing some FTP commands that I need. See the releases for a download
